...
def main(cnn, decoder, beam_width):
    ...
    if cnn == 3:
        ...
        raise TypeError("Invalid cnn value {cnn}")
    ...
    all_preds, all_refs, all_filenames = test_one_epoch(
        model,
        test_loader,
        torch.device(device),
        decoder,
